...
export const pendingQuote: PayInQuote = {
	...
	expiryDate: Date.now() + 4 * 24 * 60 * 60 * 1000, // 6 days
...
export const acceptedQuote: PayInQuote = {
	...
	merchantId: "fb140b88-7296-4397-bd9e-47b29a4805ee",
	dateCreated: Date.now(),
	expiryDate: Date.now() + 4 * 24 * 60 * 60 * 1000, // 4 days
	quoteExpiryDate: Date.now() + 4 * 24 * 60 * 60 * 1000, // 4 days,
	acceptanceExpiryDate: Date.now() + 4 * 24 * 60 * 60 * 1000, // 4 days,
